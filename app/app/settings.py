...
SECRET_KEY = 'django-insecure--z!-5bs8z7v$kn8^@brvg)$$+x7&fwu766bpfd5opf%i@$s%4#'
...
# this has been set up in the docker-compose.yml file and is just being pulled in here
DATABASES = {
    'default': {
